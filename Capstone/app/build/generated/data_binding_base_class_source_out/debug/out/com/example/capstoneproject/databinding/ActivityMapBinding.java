...
public final class ActivityMapBinding implements ViewBinding {
  ...
  private ActivityMapBinding(@NonNull LinearLayout rootView, @NonNull ImageView back,
      @NonNull LinearLayout mapView) {
  ...
  public static ActivityMapBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.map_view;
      LinearLayout mapView = ViewBindings.findChildViewById(rootView, id);
      if (mapView == null) {
        break missingId;
      }

      return new ActivityMapBinding((LinearLayout) rootView, back, mapView);
    }
