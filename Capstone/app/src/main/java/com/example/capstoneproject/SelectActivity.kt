...
//                // val urlParameters = "sn=C02G8416DRJM&cn=&locale=&caller=&num=12345"
//                // 서버와의 연결 생성
...
////
//                var os = urlConnection.outputStream
//                var jsonInputString = "{id:faker}"
...
//                    Log.d(TAG, "$photoFile")
                        img_networking("http://13.125.224.42:5000/", photoFile)
                } else {
